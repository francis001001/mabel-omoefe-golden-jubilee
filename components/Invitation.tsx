  ...
  return (
    <Reveal>
      <section className="py-[12vh] px-[6vw] pb-[8vh] text-center max-w-[900px] mx-auto relative">
        ...
        <p className="font-cormorant italic font-light text-[clamp(1.4rem,3vw,2rem)] leading-[1.5] text-ink-soft mb-8">
          You are warmly invited to the
          <br />
          most golden of celebrations —
        </p>

        <h2 className="font-italiana text-[clamp(2.5rem,7vw,5rem)] text-ink tracking-[0.12em] my-6 relative inline-block">
        ...
        <p className="font-cormorant italic text-xl text-gold-deep mb-4">
